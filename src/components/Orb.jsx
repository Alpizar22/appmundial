...
export default function Orb({ region, mode, onActivate, onOpenCases }) {
  ...
  useEffect(()=>{
    ...
    let frame=0,startFrame=0,width=0,height=0,scrollTarget=0,scrollProgress=0,journeyTarget=0,journeyFocus=0,running=true,reduced=reducedQuery.matches,model=[],hasPainted=false
